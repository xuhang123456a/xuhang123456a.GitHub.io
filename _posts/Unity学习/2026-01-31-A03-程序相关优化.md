...
TOC***Unity(httpszhuanlan.zhihu.comp)Unity*GameObjectSpawnPool*Transform*Play()*Material.GetXX()Material.SetXX()*onditional*GetComponent()*UnityEngine.Objectnull*Transform.positionrotation**structobject*QueueStackList*pacity*sealed*ictionaryUnityUnity(httpszhuanlan.zhihu.comp)monomono.UpdateixedUpdate.log.StringBuilderStringPIGetComponent.Structlass.newluaUnityLua(httpslog.uwa4d.comrchivesUWA_ReportModule4.html)
